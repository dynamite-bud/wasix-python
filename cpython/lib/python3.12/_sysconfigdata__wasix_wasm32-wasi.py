...
build_time_vars = {'ABIFLAGS': '',
 ...
 'BASEMODLIBS': '',
 'BINDIR': '/cpython/bin',
 'BINLIBDEST': '/cpython/lib/python3.12',
 ...
 'CFLAGS': '-fno-strict-overflow -DNDEBUG -g -O3 -Wall '
           '-I/home/seb/wasix-libs/include '
           '-I/home/seb/wasix-libs/include/ncurses '
           ...
           '-ftls-model=local-exec -fno-trapping-math -DOPENSSL_THREADS -O2 -g '
           '-flto',
 'CFLAGSFORSHARED': '',
 ...
 'CONFIGFILES': 'configure configure.ac acconfig.h pyconfig.h.in '
                'Makefile.pre.in',
 'CONFIGURE_CFLAGS': '-I/home/seb/wasix-libs/include '
                     '-I/home/seb/wasix-libs/include/ncurses '
                     '-I/home/seb/git/sqlite/build/ '
                     '-I/home/seb/git/liblzma/src/liblzma/api '
                     ...
                     '-fno-trapping-math -DOPENSSL_THREADS -O2 -g -flto',
 ...
 'CONFIG_ARGS': "'--disable-shared' '--host=wasm32-unknown-wasix' "
                "'--target=wasm32-unknown-wasix' '--prefix=/cpython' "
                ...
                "'--with-pkg-config=no' '--with-openssl=/home/seb/git/openssl' "
                "'--enable-wasm-pthreads' '--enable-ipv6' "
                "'build_alias=x86_64-linux-gnu' "
                "'host_alias=wasm32-unknown-wasix' "
                "'target_alias=wasm32-unknown-wasix' 'CC=clang-15 "
                '--target=wasm32-wasi '
                "--sysroot=/home/seb/wasix-libc/sysroot32' "
                "'CFLAGS=-I/home/seb/wasix-libs/include "
                '-I/home/seb/wasix-libs/include/ncurses '
                '-I/home/seb/git/sqlite/build/ '
                '-I/home/seb/git/liblzma/src/liblzma/api '
                '-I/home/seb/git/openssl/include -I/home/seb/git/zlib '
                ...
                '-mthread-model posix -ftls-model=local-exec '
                "-fno-trapping-math -DOPENSSL_THREADS -O2 -g -flto' "
                "'LIBS=-L/home/seb/wasix-libs/lib "
 ...
 'CONFINCLUDEDIR': '/cpython/include',
 'CONFINCLUDEPY': '/cpython/include/python3.12',
 'COREPYTHONPATH': '',
 ...
 'DESTDIRS': '/cpython /cpython/lib /cpython/lib/python3.12 '
             '/cpython/lib/python3.12/lib-dynload',
 'DESTLIB': '/cpython/lib/python3.12',
 'DESTPATH': '',
 'DESTSHARED': '/cpython/lib/python3.12/lib-dynload',
 'DFLAGS': '',
 'DIRMODE': 755,
 ...
 'EXE': '.wasm',
 'EXEMODE': 755,
 'EXENAME': '/cpython/bin/python3.12.wasm',
 'EXPORTSFROM': '',
 'EXPORTSYMS': '',
 'EXTRATESTOPTS': '',
 'EXTRA_CFLAGS': '',
 ...
 'INCLDIRSTOMAKE': '/cpython/include /cpython/include '
                   '/cpython/include/python3.12 /cpython/include/python3.12',
 'INCLUDEDIR': '/cpython/include',
 'INCLUDEPY': '/cpython/include/python3.12',
 ...
 'LIBHACL_CFLAGS': '-I../Modules/_hacl/include -D_BSD_SOURCE -D_DEFAULT_SOURCE '
                   ...
                   '-matomics -mbulk-memory -mmutable-globals -pthread '
                   '-mthread-model posix -ftls-model=local-exec '
                   '-fno-trapping-math -DOPENSSL_THREADS -O2 -g -flto -std=c11 '
 ...
 'LIBOBJDIR': 'Python/',
 'LIBOBJS': '',
 'LIBPC': '/cpython/lib/pkgconfig',
 'LIBPL': '/cpython/lib/python3.12/config-3.12-wasm32-wasi',
 'LIBPYTHON': '',
 'LIBRARY': 'libpython3.12.a',
 'LIBRARY_DEPS': 'libpython3.12.a',
 'LIBRARY_OBJS': '\\',
 'LIBRARY_OBJS_OMIT_FROZEN': '\\',
 'LIBS': '-L/home/seb/wasix-libs/lib -L/home/seb/git/sqlite/build/.libs '
 ...
 'LOCALMODLIBS': '-lm -lm -lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a '
                 '-lz -llzma -lz -lreadline    '
                 'Modules/_hacl/libHacl_Hash_SHA2.a   -lm '
                 'Modules/expat/libexpat.a                -lncurses -lsqlite3 '
                 '-L/home/seb/git/openssl/lib  -lssl -lcrypto '
                 '-L/home/seb/git/openssl/lib   -lcrypto',
 'MACHDEP': 'wasix',
 'MACHDEP_OBJS': '',
 'MACHDESTLIB': '/cpython/lib/python3.12',
 'MACOSX_DEPLOYMENT_TARGET': '',
 'MAJOR_IN_MKDEV': 0,
 'MAJOR_IN_SYSMACROS': 0,
 'MAKESETUP': '../Modules/makesetup',
 'MANDIR': '/cpython/share/man',
 ...
 'MODBUILT_NAMES': 'array  _asyncio  _bisect  _contextvars  _csv  _heapq  '
                   ...
                   '_datetime  _decimal  binascii  _lzma  zlib  readline  '
                   ...
                   '_crypt  _posixsubprocess  select  _socket  termios  '
                   '_multiprocessing  _curses  _sqlite3  _ssl  _hashlib  '
                   ...
                   '_locale  _operator  _stat  _symtable',
 'MODDISABLED_NAMES': '',
 'MODLIBS': '-lm -lm -lm -lm -lm -lm Modules/_decimal/libmpdec/libmpdec.a -lz '
            '-llzma -lz -lreadline    Modules/_hacl/libHacl_Hash_SHA2.a   -lm '
            'Modules/expat/libexpat.a                -lncurses -lsqlite3 '
            '-L/home/seb/git/openssl/lib  -lssl -lcrypto '
            '-L/home/seb/git/openssl/lib   -lcrypto',
 'MODOBJS': 'Modules/arraymodule.o  Modules/_asynciomodule.o  '
            ...
            'Modules/_lzmamodule.o  Modules/zlibmodule.o  Modules/readline.o  '
            ...
            'Modules/termios.o  Modules/_multiprocessing/multiprocessing.o '
            'Modules/_multiprocessing/semaphore.o  Modules/_cursesmodule.o  '
            'Modules/_sqlite/blob.o Modules/_sqlite/connection.o '
 ...
 'MODULE__HASHLIB_CFLAGS': '-I/home/seb/git/openssl/include',
 'MODULE__HASHLIB_DEPS': '../Modules/hashlib.h',
 'MODULE__HASHLIB_LDFLAGS': '-L/home/seb/git/openssl/lib   -lcrypto',
 ...
 'MODULE__SRE_LDFLAGS': '',
 'MODULE__SSL_CFLAGS': '-I/home/seb/git/openssl/include',
 ...
 'MODULE__SSL_LDFLAGS': '-L/home/seb/git/openssl/lib  -lssl -lcrypto',
 ...
 'PYTHONPATH': '',
 'PYTHON_FOR_BUILD': '_PYTHON_PROJECT_BASE=/home/seb/git/cpython/build_wasm '
                     '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
                     'PYTHONPATH=$(shell test -f '
                     '/home/seb/git/cpython/build_wasm/pybuilddir.txt && echo '
                     '/home/seb/git/cpython/build_wasm/`cat '
                     'pybuilddir.txt`:)../Lib '
                     '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasix_wasm32-wasi '
 ...
 'PY_BUILTIN_MODULE_CFLAGS': '-fno-strict-overflow -DNDEBUG -g -O3 -Wall '
                             ...
                             '-DOPENSSL_THREADS -O2 -g -flto -std=c11 '
 ...
 'PY_CFLAGS': '-fno-strict-overflow -DNDEBUG -g -O3 -Wall '
              ...
              '-I/home/seb/git/openssl/include -I/home/seb/git/zlib -matomics '
              '-mbulk-memory -mmutable-globals -pthread -mthread-model posix '
              '-ftls-model=local-exec -fno-trapping-math -DOPENSSL_THREADS -O2 '
              '-g -flto',
 ...
 'TESTOPTS': '',
 'TESTPATH': '',
 'TESTPYTHON': '_PYTHON_PROJECT_BASE=/home/seb/git/cpython/build_wasm '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f '
               '/home/seb/git/cpython/build_wasm/pybuilddir.txt && echo '
               '/home/seb/git/cpython/build_wasm/`cat pybuilddir.txt`:)../Lib '
               '_PYTHON_SYSCONFIGDATA_NAME=_sysconfigdata__wasix_wasm32-wasi '
               '/home/seb/git/cpython/build_wasm/../build64/python',
 'TESTPYTHONOPTS': '',
 'TESTRUNNER': '_PYTHON_PROJECT_BASE=/home/seb/git/cpython/build_wasm '
               '_PYTHON_HOST_PLATFORM=$(_PYTHON_HOST_PLATFORM) '
               'PYTHONPATH=$(shell test -f '
               '/home/seb/git/cpython/build_wasm/pybuilddir.txt && echo '
               '/home/seb/git/cpython/build_wasm/`cat pybuilddir.txt`:)../Lib '
 ...
 'VERSION': '3.12',
 'VPATH': '..',
 'WASM_ASSETS_DIR': './cpython',
 'WASM_STDLIB': './cpython/lib/python3.12/os.py',
 'WHEEL_PKG_DIR': '',
 'WINDOW_HAS_FLAGS': 1,
